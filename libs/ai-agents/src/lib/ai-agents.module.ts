...
@Module({
  ...
  providers: [AgentOrchestrator, PiiShieldService, SemanticCacheService, OpenClawService, ProductCacheSubscriber],
  exports: [AgentOrchestrator, PiiShieldService, SemanticCacheService, OpenClawService],
})
