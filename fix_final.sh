...
# Manually create temporary schema and concatenate
cp libs/database/prisma/schema.prisma /tmp/schema.prisma

cat << 'INNER_EOF' >> /tmp/schema.prisma
...
mv /tmp/schema.prisma libs/database/prisma/schema.prisma
